...
int main(int argc, char** argv) {
    ...
    {
    case 1:
        doTransform("img/640x480.jpg", thd_per_blk);
        break;
    case 2:
        doTransform("img/1280x720.jpg", thd_per_blk);
        break;
    case 3:
        doTransform("img/1920x1080.jpg", thd_per_blk);
        break;
    case 4:
        doTransform("img/2560x1440.jpg", thd_per_blk);
        break;
    case 5:
        doTransform("img/3840x2160.jpg", thd_per_blk);
        break;
    case 6:
        doTransform("img/7680x4320.jpg", thd_per_blk);
        break;
    case 7:
    ...
    //doTransform(img_path, thd_per_blk);
